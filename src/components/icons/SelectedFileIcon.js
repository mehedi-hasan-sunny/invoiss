...
const SelectedFileIcon = (props) => {
	...
	return (
			<SvgIcon style={{fontSize: fontSize, color: getColor}} color={"primary"} {...otherProps}>
				<g id="Stockholm-icons-/-Files-/-Selected-file" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
export default SelectedFileIcon;