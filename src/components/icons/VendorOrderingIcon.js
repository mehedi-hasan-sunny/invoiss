const VendorOrderingIcon = (props) => {
	...
	return (
			<div className={"custom-icon" + (props.className ? ' ' : '') + props.className} {...otherProps}>
				<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
					...
					<title></title>
					<desc></desc>
					<g id="Stockholm-icons-/-Shopping-/-Cart#1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
export default VendorOrderingIcon;