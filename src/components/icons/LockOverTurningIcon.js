...
const LockOverTurningIcon = (props) => {
	...
	return (
			<SvgIcon style={{fontSize: fontSize, color: getColor}} color={"primary"} {...otherProps}>
				<g id="Stockholm-icons-/-Code-/-Lock-overturning" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
LockOverTurningIcon.propTypes = {
	color: PropTypes.string,
	fontSize: PropTypes.string
};
export default LockOverTurningIcon;