...
const FileDoneIcon = (props) => {
	...
	return (
			<SvgIcon style={{fontSize: fontSize, color: getColor}} color={"primary"} {...otherProps}>
				<g id="Stockholm-icons-/-Files-/-File-done" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
					...
					<path
							...
							id="check-path" fill="currentColor"/>
				</g>
			</SvgIcon>
	);
};
FileDoneIcon.propTypes = {
	color: PropTypes.string,
	fontSize: PropTypes.string
};
export default FileDoneIcon;